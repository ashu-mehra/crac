...
void os::Linux::restore() {
  ...
  int id = getpid();
  const SystemProperty* props = Arguments::system_properties_for_restore();
  const int props_count = Arguments::PropertyList_count((SystemProperty *)props);
